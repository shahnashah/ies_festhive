  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen bg-black">
              ...
              <div className="bg-gradient-to-b from-black-900 to-yellow-900 flex items-center justify-center py-10 mt-20">
                <div className="grid grid-cols-2 md:grid-cols-2 gap-6 px-4">
                  {stats.map((stat, index) => (
                    <div key={index} className="bg-blue-950 text-white p-6 rounded-xl shadow-lg text-center transition-transform transform hover:scale-105">
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-yellow-600">
              {[
                { icon: "📝", title: "Online Registration", desc: "Allow attendees to register easily with custom forms and instant confirmation." },
                { icon: "📊", title: "Live Analytics", desc: "Track registrations, engagement, and attendance in real-time." },
                { icon: "📧", title: "Automated Notifications", desc: "Send timely reminders and updates via email and SMS." },
                { icon: "🗓️", title: "Schedule Management", desc: "Create and share event schedules with built-in reminders." },
                { icon: "🏛️", title: "Venue & Resource Booking", desc: "Reserve locations and manage event logistics efficiently." },
                { icon: "💬", title: "Feedback Collection", desc: "Gather post-event feedback to continuously improve experiences." },
              ].map((feature, index) => (
        ...
        {/* CONTACT Section */}
        <section id="contact" className="py-20 bg-gradient-to-r from-black-600 to-yellow-900 text-white">
          <Contact />
        </section>
